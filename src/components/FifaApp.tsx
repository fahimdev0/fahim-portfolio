      ...
      <div className="w-full max-w-md mx-auto px-4 z-10 flex flex-col h-full pt-3">
        ...
        <div className="shrink-0 flex flex-col">
          ...
          <section className="flex flex-col gap-3 mb-3">
            <div className="grid grid-cols-2 gap-1 p-0.5 bg-zinc-950/80 border border-zinc-800/40 rounded-xl select-none shrink-0 w-full">
              {[
                ...
                <button
                  ...
                  className={`text-center py-2.5 rounded-lg text-[10px] font-black tracking-tight leading-none transition-all cursor-pointer ${
                    activeTab === tab.id
        ...
        <section className="flex-grow overflow-y-auto no-scrollbar pb-6 animate-fadeIn">
